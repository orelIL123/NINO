...
const shapes = {
  ...
  sandal: {
    body: "M182 656 Q182 628 216 626 L588 626 Q624 628 624 660 L624 686 Q624 714 590 714 L214 714 Q182 714 182 684 Z M252 626 Q262 552 334 548 L470 548 Q542 552 552 626 L502 626 Q494 588 452 586 L350 586 Q308 588 302 626 Z",
    lines: ["M182 690 L624 690"],
  },
  scarf: {
