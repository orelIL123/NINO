...
export default function EmptyProducts({ locale, compact = false }: { locale: Locale; compact?: boolean }) {
  ...
  return (
    <div className={`relative overflow-hidden border border-line bg-tile text-center ${compact ? "py-10" : "py-16"}`}>
      <Image src="/media/coming-soon.svg" alt="" fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover opacity-45" />
